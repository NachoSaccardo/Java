...
public class FabricaMotores {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ingrese el codigo de motor");
        int tipoMotor = leer.nextInt();
        switch (tipoMotor) {
            case 1:
                System.out.println("La bomba es una boma de agua");
                break;
            case 2:
            ...
            case 3:
                ...
                break;
            case 4:
                System.out.println("La bomba es una boma de pasta alimenticia");
                break;
            default:
